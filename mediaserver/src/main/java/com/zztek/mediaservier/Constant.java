...
public interface Constant {
	...
	public class MusicPlayControl {
		...
		public static String DECREASEAUDIO = "com.action.descrease.audio" ;
		
		public static String INCREASEAUDIO = "com.action.inscrease.audio" ;
		
		public static String UPDATEUI = "com.action.update.ui" ;
		
		public static final int MUSIC_PALY_DATA_INT = 1;
		
		public static final String mMusicRecevierAction =  "com.iwit.ds.music";
	}
